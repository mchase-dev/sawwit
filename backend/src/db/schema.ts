...
export const topics = pgTable('topics', {
  ...
  idxTrendingScore: index('idx_topics_trending').on(table.trendingScore),
  idxLastActivity: index('idx_topics_last_activity').on(table.lastActivityAt),
}));
...
export const topicMembers = pgTable('topic_members', {
  ...
  idxUserId: index('idx_topic_members_user').on(table.userId),
}));
...
export const posts = pgTable('posts', {
  ...
  idxTopicCreated: index('idx_posts_topic_created').on(table.topicId, table.createdAt),
  idxAuthorCreated: index('idx_posts_author_created').on(table.authorId, table.createdAt),
...
export const comments = pgTable('comments', {
  ...
  idxPostCreated: index('idx_comments_post_created').on(table.postId, table.createdAt),
  idxAuthorCreated: index('idx_comments_author_created').on(table.authorId, table.createdAt),
  idxParent: index('idx_comments_parent').on(table.parentId),
}));
...
export const votes = pgTable('votes', {
  ...
  idxPostId: index('idx_votes_post').on(table.postId),
  idxCommentId: index('idx_votes_comment').on(table.commentId),
}));
...
export const notifications = pgTable('notifications', {
  ...
  idxUserStatus: index('idx_notifications_user_status').on(table.userId, table.status),
...
export const userBadges = pgTable('user_badges', {
  ...
  uniqueTopicUser: unique().on(table.topicId, table.userId),
  idxUserId: index('idx_user_badges_user').on(table.userId),
}));
...
export const reports = pgTable('reports', {
  ...
  idxStatusCreated: index('idx_reports_status_created').on(table.status, table.createdAt),
}));
...
export const savedPosts = pgTable('saved_posts', {
  ...
  uniqueUserPost: unique().on(table.userId, table.postId),
  idxUserSaved: index('idx_saved_posts_user').on(table.userId, table.savedAt),
}));
